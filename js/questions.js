const questions = [
  ...
  // ===== PART 2: APLIKASI INTEGRAL (LO2, 25 poin) =====
  {
    id: "2a",
    part: 2,
    partName: "Aplikasi Integral",
    lo: "LO2",
    poin: 5,
    soal: "Gambarlah daerah R yang dibatasi oleh y = x\\sqrt{x}, x = 1, x = 4, dan y = 0. Hitunglah:\n\ni. Luas R\nii. Panjang kurva y\niii. Volume jika R diputar mengelilingi sumbu x\niv. Volume jika R diputar mengelilingi y = -1",
  ...
  },
  {
    ...
    lo: "LO2",
    poin: 4,
    soal: "Sketsalah daerah yang dibatasi oleh kurva 4y^2 - 2x = 0 dan 4y^2 + 4x - 12 = 0. Lalu hitung luas daerah tersebut.",
  ...
  },
  {
    ...
    lo: "LO2",
    poin: 4,
    soal: "Sketsalah daerah yang dibatasi oleh x = 2\\sqrt{y}, y = 4, x = 0. Tentukan volume benda solid jika diputar mengelilingi sumbu-y.",
  ...
  },
  {
    ...
    lo: "LO2",
    poin: 4,
    soal: "Sketsalah daerah yang dibatasi oleh x = 4y^4 dan x = 8 - 4y^4. Lalu hitung luas daerah tersebut.",
  ...
  // ===== PART 3: DERET DAN KEKONVERGENAN (LO3, 30 poin) =====
  {
    id: "3ai",
    part: 3,
    partName: "Deret dan Kekonvergenan",
    lo: "LO3",
    poin: 3,
  ...
  // ===== PART 4: DERET TAYLOR & MACLAURIN (LO4, 15 poin) =====
  {
    id: "4a",
    part: 4,
    partName: "Deret Taylor & Maclaurin",
    lo: "LO4",
    poin: 5,
    soal: "Perderetkan f(x) = \\sqrt{x} dengan deret Taylor minimal sampai orde ke-3 (turunan ke-3) dengan pusat x = 2.",
  ...
  },
  {
    ...
    lo: "LO4",
    poin: 5,
    soal: "Perderetkan f(x) = \\tan^{-1}x dengan deret Maclaurin minimal sampai orde ke-4 (turunan ke-4).",
  ...
  },
  {
    ...
    lo: "LO4",
    poin: 5,
    soal: "Perderetkan f(x) = \\cot^{-1}x dengan deret Taylor minimal sampai orde ke-3 (turunan ke-3) dengan pusat x = 1.",
